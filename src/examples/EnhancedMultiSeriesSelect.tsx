...
const EnhancedMultiSeriesChart: React.FC<MultiSeriesChartProps> = ({
  width = 800,
  height = 400,
  series,
}) => {
  ...
  const handleMouseMove = useCallback(
    ...
    [xScale, yScale, series, activeSeriesNames, margin],
  );
  ...
  return (
    <div className="relative" style={{ width }}>
      ...
      {/* 시리즈별 툴팁 */}
      {hoverInfo.tooltips.map((tooltip, i) => (
        <SeriesToolTip
...
export const EnhancedChartExample: React.FC = () => {
  ...
  return (
    <div className="p-4">
      <EnhancedMultiSeriesChart width={900} height={400} series={seriesData} />
    </div>
  );
};
